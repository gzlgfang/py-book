...
# 用于minimize调用的约束条件
cons1 = (
    {"type": "eq", "fun": lambda x: x[0] ** 2 + x[1] + x[2] - 36},
...
res1 = optimize.minimize(
    fun, x0=(5, 4, 0.7), method="SLSQP", bounds=bnds, constraints=cons1
)
print("res1=\n", res1)
...
res2 = optimize.fmin_slsqp(
    fun, x0=(2, 2, 2), f_eqcons=eq_cons, f_ieqcons=cons, bounds=bnds
)
print("res2=")
print(res2)
