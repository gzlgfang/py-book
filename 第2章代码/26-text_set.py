...
ax[1].text(5,-0.85,'主刻度线' ,bbox=dict( facecolor="w",alpha=1,edgecolor='b',lw=2))
...
ax[2].text(9.5,-0.89,'最低点' ,bbox=dict( facecolor="pink",alpha=0.5,edgecolor='b',lw=2))
