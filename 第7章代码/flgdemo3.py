...
# Form implementation generated from reading ui file 'flgdemo3.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.textEdit.setGeometry(QtCore.QRect(430, 160, 301, 87))
        font = QtGui.QFont()
        font.setFamily("黑体")
        ...
        self.label.setGeometry(QtCore.QRect(430, 90, 291, 71))
        font = QtGui.QFont()
        ...
        self.lcdNumber.setGeometry(QtCore.QRect(430, 270, 291, 101))
        self.lcdNumber.setObjectName("lcdNumber")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(150, 190, 151, 111))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(20)
