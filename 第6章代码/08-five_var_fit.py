...
# print(func(x,*a))
fit_cc, fit_cv = op.curve_fit(
    func, x, y_real, p0=[2, 1.5, 0.6, 0.9, 1.2, 2]
)  # 拟合曲线curvefit方法
print(
    f"a_0={fit_cc[0]:.5f},a_1={fit_cc[1]:.5f}, a_2={fit_cc[2]:.5f},a_3={fit_cc[3]:.5f},a_4={fit_cc[4]:.5f}, a_5={fit_cc[5]:.5f}"
)
ydata = func(x, *fit_cc)
print("ydata=:\n", ydata)
# 计算绝对百分误差平均值
