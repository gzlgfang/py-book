...
#x = np.arange(9.4,-0.1, -0.1)  # 确定自变量范围,右边界
...
plt.annotate('y_a=y_left',xy=(0,y_left),xytext=(2,y_left-3) ,bbox=dict( facecolor="w",alpha=1,edgecolor='r',lw=2),
                arrowprops=dict(arrowstyle='->',color="r",lw=2))


plt.annotate('y_b=y_right',xy=(10,y_right),xytext=(7,y_right-3) ,bbox=dict( facecolor="w",alpha=1,edgecolor='b',lw=2),
...
plt.annotate('y_b=y_0',xy=(10,y0),xytext=(8,y0-3) ,bbox=dict( facecolor="w",alpha=1,edgecolor='b',lw=2),
                arrowprops=dict(arrowstyle='->',color="b",lw=2))
...
plt.legend()
plt.grid(True)
plt.annotate('y_a=y_0',xy=(0,y0),xytext=(2,y0-3) ,bbox=dict( facecolor="w",alpha=1,edgecolor='b',lw=2),
                arrowprops=dict(arrowstyle='->',color="b",lw=2))
plt.title("左端点确定问题")
