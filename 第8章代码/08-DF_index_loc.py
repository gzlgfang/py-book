...
import numpy as np
import pandas as pd
dict = {"city":['A城', 'B城', 'C城', 'D城', 'E城','F城'],"GDP":[12390,10890,1900,8901,7821,6532],"Population":[103,98,160,102,98,89],"Incre_rate":[1.4,2.1,-1.5,3.2,3.1,0.8]}
...
print("GDP省总和排序:\n",DF4.drop('number',axis=1).sum(level='province').sort_values("GDP",ascending=False))

print("GDP省上榜城市平均值排序:\n",DF4.drop('number',axis=1).mean(level='province').sort_values("GDP",ascending=False))
